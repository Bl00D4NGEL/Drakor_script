                    ...
                    document.getElementById("char_inventory").childNodes[i].addEventListener("click", function (f) {
                        var mySecondTimer = setInterval(function () {
                            if (document.getElementsByClassName("linkSell").length > 0) {
                                ...
                                if (document.getElementById("card" + targetID) !== null && document.getElementById("card" + targetID).childNodes.length > 1) {
                                    if (document.getElementById("card" + targetID).childNodes[1].childNodes[0].getElementsByClassName("linkDisenchant").length > 0) {
                                        console.log(document.getElementById("card" + targetID).childNodes[1].childNodes[0].getElementsByClassName("linkDisenchant").length);
